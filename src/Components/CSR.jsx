...
import pic8 from '../Images/CSR/pic8.PNG'
import pic9 from '../Images/CSR/pic9.PNG'
    ...
    return (
        <div>
            ...
            <Box w="95%" m="auto" style={{ boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px", padding: "50px", borderRadius: "40px" }}>
                <SimpleGrid columns={{ base: 1, sm: 1, md: 2, lg: 3 }} spacing={12}>
                    <Box  height='300px'>
                    ...
                    <Box  height='400px'>
                        <Image src={pic8} w={'100%'} h={'100%'} />
                    </Box>
                    <Box  height='400px'>
                        <Image src={pic9} w={'100%'} h={'100%'} />
                    </Box>
                </SimpleGrid>
