    ...
    <Container maxW={"7xl"} p="12">
      ...
      >
        <Stack flex={1} spacing={{ base: 5, md: 10 }} >
          <List gap={8}>
            <ListItem fontSize="28px" textAlign={"left"} width="110%" mt="15px" >
            ...
            >
              <Text fontSize={"18px"} color="black" >
                <ListIcon
                  ...
                  w="50px"
                />
                The company has executed a number of civil works in India and
                Nepal
              </Text>
            </ListItem>
            <ListItem fontSize="28px" textAlign={"left"} width="130%" mt="15px" >
              <Text fontSize={"18px"} color="black">
                {" "}
                <ListIcon
                  as={MdCheckCircle}
                  ...
                  w="50px"
                />{" "}
                The clien tele includes Government, Quasi Government and
                esteemed Indian Corporates
              </Text>
            </ListItem>

            <ListItem fontSize="28px" textAlign={"left"} mt="15px" >
              <Text fontSize={"18px"} color="black">
                {" "}
                <ListIcon
                  as={MdCheckCircle}
            ...
            <ListItem fontSize="28px" textAlign={"left"} width="130%" mt="15px" >
              <Text fontSize={"18px"} color="black">
                ...
                />{" "}
                Complete civil and structural services for all types of
