  ...
  return (
    <Box py={12}>
      ...
      <Stack
        ...
        <PriceWrapper>
          <Box py={4} px={12}>
            <Text fontWeight="500" color={"red"} fontSize="2xl" _hover={{ textDecoration: 'none',color:"black" }}>
              Vision
            </Text>
        ...
        <PriceWrapper>
          <Box position="relative">
            ...
            <Box py={4} px={12}>
              <Text color={"red"} fontWeight="500" fontSize="2xl" _hover={{ textDecoration: 'none',color:"black" }}>
                Mission
              </Text>
